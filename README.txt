...
скрытно от меня, теперь я делаю более явно и без ненужного оверхэда. Убрались лишние проходны по данным. Итог оптимизации этой части: удалось в 2.5-3 раза уменьшить
время работы.
...
Не стал для оптимизаций использовать самописные хэштаблицы, кучи или какие-то контейнеры, так как за адекватное и небольшое время 
выполнения тестового невозможно что-то подобное написать так, чтобы оно работало без косяков. Одно покрытие тестами чего будет стоить.
Я за алгоритмическую оптимизацию и, кажется, что с этой точки зрения результат достойный.
